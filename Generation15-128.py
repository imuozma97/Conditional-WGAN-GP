...
from config import batch_size1, image_size2, num_cv, n_bar2
from histo import Histogramas
#from gif import gif
from transforms import forward_2,backward_2

trained_models_folder = "Training3D-128/15-models"
generated_images_folder = "Training3D-128/15-images"
epoch = "00761"
N=27
...
"""
k_values = datos.load_k_values("PSD_delta_128.npz")
