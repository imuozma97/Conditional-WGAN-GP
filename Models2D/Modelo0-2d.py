...
from architectures2d.generators2d import Generator_concat
from architectures2d.discriminators2d import Discriminator_concat
from training import Training
from psd_utils import lambda_psd_schedule



trained_models_folder = "Training2D/0-models"
generated_images_folder = "Training2D/0-images"
...
generator = Generator_concat(filter1 = 256, filter2 = 128, filter3 = 64)
discriminator = Discriminator_concat(filter1 = 64, filter2 = 128, filter3 = 256)   
