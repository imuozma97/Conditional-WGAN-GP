...
class Training3(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        real_images, z_values, psd_max, psd_min,  psd_real, sigma_log = data  
        pca = PCA(n_components=3)
        coeffs_real = pca.fit_transform(psd_real)
        ...
        for _ in range(self.ncritic):
            ...
            with tf.GradientTape() as disc_tape:
                ...
                coeffs_fake = pca.fit_transform(psd_gen)
