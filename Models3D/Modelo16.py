...
trained_models_folder = "Training3D/16-models"
generated_images_folder = "Training3D/16-images"
...
psd_max, psd_min, _, psd_sigma, all_psd = datos.load_psd("PSD_delta.npz")

dataset = datos.crea_dataset(forw, z_vals, psd_max, psd_min, all_psd)
