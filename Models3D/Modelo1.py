"""
Datos4 + Arquitectura1
Datos: forward(delta + 1) + Normalización +salida 'tanh' en el Generador
Generator_film3
...
trained_models_folder = "Training3D/1-models"
generated_images_folder = "Training3D/1-images"
...
data_norm, max_desnorm, min_desnorm = datos.normalizar_datos_tanh(forw)
...
dataset = datos.crea_dataset(data_norm, z_vals, psd_max, psd_min, mean_psd, psd_sigma)
...
cgan = Training1(data_class = datos, discriminator = discriminator, generator = generator, batch_size = batch_size1, ncritic = ncritic3, 
                ...
                lambda_term = 20, max_desnorm = max_desnorm, min_desnorm = min_desnorm, use_psd = False, use_psd_loss = False)
