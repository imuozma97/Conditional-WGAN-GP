...
from training8 import Training8
...
cgan = Training8(data_class = datos, discriminator = discriminator, generator = generator, batch_size = batch_size1, ncritic = ncritic3, 
