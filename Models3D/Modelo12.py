...
trained_models_folder = "Training3D/12-models"
generated_images_folder = "Training3D/12-images"
...
discriminator = Discriminator_projection_swish(filter1 = 32, filter2 = 64, filter3 = 128, layer = "GAP")
