...
from architectures.generators import Generator_concat_linear
from architectures.discriminators import Discriminator_projection
from training2 import Training2
from transforms import forward_1
from psd_utils import lambda_psd_schedule


trained_models_folder = "Training3D/2-models"
generated_images_folder = "Training3D/2-images"
...
generator = Generator_concat_linear(filter1 = 256, filter2 = 128, filter3 = 64)
discriminator = Discriminator_projection(filter1 = 32, filter2 = 64, filter3 = 128, layer = "F")


#Cargamos la red principal
cgan = Training2(data_class = datos, discriminator = discriminator, generator = generator, batch_size = batch_size1, ncritic = ncritic3, 
