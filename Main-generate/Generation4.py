...
psd_max_norm, psd_min_norm, psd_mean_norm, psd_sigma_norm, _ = datos.load_psd("PSD_norm_c100.npz")
...
psd_max_desnorm, psd_min_desnorm, psd_mean_desnorm, psd_sigma_desnorm,_ = datos.load_psd("PSD_delta_c100.npz")
...
gif(os.path.join(generated_images_folder, f"compare_psd_individual{epoch}"), f"psd_gif_{epoch}.gif")
