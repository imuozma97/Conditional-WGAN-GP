...
datos= Dataset(batch_size1, n_bar, alpha = 1)
...
norm_data, z_vals, max_val, min_val= datos.load_cubos("Data3D-64.hdf5", "global_norm")
desnorm_data = datos.desnormalizar_datos(norm_data, max_val, min_val)
delta_real = datos.asinh_inv(desnorm_data)

norm_data_agrupados = datos.reordenacion(num_cv, norm_data)
desnorm_data_agrupados = datos.desnormalizar_datos(norm_data_agrupados, max_val, min_val)
desnorm_data_agrupados = datos.asinh_inv(desnorm_data_agrupados)


#PSD DATOS REALES NORMALIZADOS
psd_max_norm, psd_min_norm, psd_mean_norm, psd_sigma_norm, _ = datos.load_psd("PSD_asinh_alpha1_norm.npz")
...
desnorm_fake = datos.desnormalizar_datos(norm_fake, max_val, min_val)
desnorm_fake = datos.asinh_inv(desnorm_fake)
