...
from gif import psd_gif
from psd_utils import lambda_psd_schedule

trained_models_folder = "Results3D/12-models"
generated_images_folder = "Results3D/12-images"
epoch = "01855"
N=100
...
psd_max_norm, psd_min_norm, psd_mean_norm, psd_sigma_norm, _ = datos.load_psd("PSD_norm_mu_sigma_c100.npz")
