...
print("Max delta z=0:", np.max(desnorm_data_agrupados[891:]), "Min delta z=0:", np.min(desnorm_data_agrupados[891:]))
print("Max delta z=6:", np.max(desnorm_data_agrupados[0:27]), "Min delta z=6:", np.min(desnorm_data_agrupados[0:27]))
