...
#DATOS REALES
norm_data, z_vals, max_desnorm, min_desnorm = datos.load_data("global_norm")
desnorm_data = datos.desnormalizar_datos(norm_data, max_desnorm, min_desnorm)
desnorm_data = backward(desnorm_data)

norm_data_agrupados = datos.reordenacion(norm_data)
...
psd_max_norm, psd_min_norm, psd_mean_norm, psd_sigma_norm = datos.load_psd("PSD_norm_c100.npz")
...
psd_max_desnorm, psd_min_desnorm, psd_mean_desnorm, psd_sigma_desnorm = datos.load_psd("PSD_delta_c100.npz")
...
norm_fake_agrupados = datos.reordenacion(norm_fake)
...
desnorm_fake_agrupados  = datos.reordenacion(desnorm_fake)
