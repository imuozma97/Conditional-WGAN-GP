...
trained_models_folder = "Results3D/43-models"
generated_images_folder = "Results3D/43-images"
epoch = "01164"
N=100
...
norm_data, z_vals, mu, sigma = datos.load_data("redshift_norm", "Data3D-64.hdf5")
...
psd_max_desnorm, psd_min_desnorm, psd_mean_desnorm, psd_sigma_desnorm, all_psd = datos.load_psd("PSD_delta_c100.npz")
