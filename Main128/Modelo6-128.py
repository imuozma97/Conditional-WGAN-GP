...
trained_models_folder = "Training128/6-models"
generated_images_folder = "Training128/6-images"
...
cgan = Training128(data_class = datos, discriminator = discriminator, generator = generator, batch_size = batch_size1, ncritic = ncritic3, 
                ...
                lambda_term = 40, image_size = image_size2, backward = backward_128, use_psd = False, use_psd_loss = True)
