...
trained_models_folder = "Training128/4-models"
generated_images_folder = "Training128/4-images"
...
generator = Generator_film_linear_swish(filter1 = 256, filter2 = 128, filter3 = 64, filter4 = 32)
...
cgan = Training128(data_class = datos, discriminator = discriminator, generator = generator, batch_size = batch_size1, ncritic = ncritic3, 
                ...
                lambda_term = 40, image_size = image_size2, use_psd = False, use_psd_loss = True)
