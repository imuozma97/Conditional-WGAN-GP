...
trained_models_folder = "Results3D/25-models"
generated_images_folder = "Results3D/25-images"
...
dataset = datos.crea_dataset(norm_data, z_vals, psd_max, psd_min, psd_mean, psd_mean)
