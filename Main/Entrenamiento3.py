...
D + projection
G + film, sin BN; 8x8x8x256; añado condición desde el principio, concatenando el embedding de z con el ruido
batch_size = 17
n_critic = 3
latent_dim = 128
...
trained_models_folder = "Results3D/3-models"
generated_images_folder = "Results3D/3-images"
