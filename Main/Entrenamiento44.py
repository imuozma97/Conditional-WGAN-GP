...
trained_models_folder = "Results3D/44-models"
generated_images_folder = "Results3D/44-images"
...
norm_data, z_vals, _, _ = datos.load_data("global_norm", "Data3D-64.hdf5")
psd_max, psd_min, _, psd_sigma, all_psd = datos.load_psd("PSD_norm_c100.npz")
