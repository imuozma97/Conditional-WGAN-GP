...
from architectures.generators import Generator_film_linear_big
...
trained_models_folder = "Results3D/33-models"
generated_images_folder = "Results3D/33-images"
...
generator = Generator_film_linear_big(filter1 = 256, filter2 = 128, filter3 = 64, filter4 = 32)
discriminator = Discriminator_projection(filter1 = 64, filter2 = 128, filter3 = 256, layer = "GAP")
