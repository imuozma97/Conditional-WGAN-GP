...
from psd_utils import lambda_psd_schedule2



trained_models_folder = "Results3D/17-models"
generated_images_folder = "Results3D/17-images"
...
cgan = Training(data_class = datos, discriminator = discriminator, generator = generator, batch_size = batch_size1, ncritic = ncritic3, 
                trained_models_folder = trained_models_folder, generated_images_folder = generated_images_folder, lambda_psd_schedule = lambda_psd_schedule2,
                use_psd = False, use_psd_loss = True)
