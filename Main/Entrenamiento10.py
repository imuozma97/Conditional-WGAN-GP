...
trained_models_folder = "Results3D/10-models"
generated_images_folder = "Results3D/10-images"
...
psd_max, psd_min, psd_mean, psd_sigma = datos.load_psd("PSD_norm_mu_sigma_c100.npz")
