...
trained_models_folder = "Results3D/52-models"
generated_images_folder = "Results3D/52-images"
...
cgan.compile(d_optimizer = tf.keras.optimizers.Adam(learning_rate = 0.00005, beta_1 = 0, beta_2 = 0.9),
             g_optimizer = tf.keras.optimizers.Adam(learning_rate = 0.00001, beta_1 = 0, beta_2 = 0.9))
