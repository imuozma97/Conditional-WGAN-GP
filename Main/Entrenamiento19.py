...
trained_models_folder = "Results3D/19-models"
generated_images_folder = "Results3D/19-images"
...
discriminator = Discriminator_projection_SN(filter1 = 64, filter2 = 128, filter3 = 256, layer = "F")
