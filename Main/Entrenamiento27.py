...
trained_models_folder = "Results3D/27-models"
generated_images_folder = "Results3D/27-images"
...
psd_max, psd_min, _, psd_sigma, all_psd = datos.load_psd("PSD_c100_forw.npz")
