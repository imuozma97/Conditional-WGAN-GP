...
from architectures.generators import Generator_film_sigmoid
from architectures.discriminators import Discriminator_projection
from training import Training



trained_models_folder = "Results3D/8-models"
generated_images_folder = "Results3D/8-images"
...
norm_data, z_vals, _, _, _, _ = datos.load_data_new("norm", salida = "sigmoid")
...
generator = Generator_film_sigmoid(filter1 = 256, filter2 = 128, filter3 = 64)
