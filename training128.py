...
class Training128(tf.keras.Model):
    ...
    def __init__(self, data_class, discriminator, generator, batch_size, ncritic, trained_models_folder, generated_images_folder, lambda_psd_schedule, lambda_term, image_size, backward, use_psd=True, use_psd_loss = True):
        super().__init__()
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as gen_tape:
            ...
            generated_images = self.generator([noise, z_values], training=True)
            delta = self.backward(generated_images) - 1
        ...
        return wass_loss, disc_loss_real, disc_loss_fake, gen_loss, loss_psd, percent, grads_norm_mean, ratio1, norm_disc, norm_gen #,psd_gen, psd_max, psd_min, 
